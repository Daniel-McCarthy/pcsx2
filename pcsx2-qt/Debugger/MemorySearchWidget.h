...
private:
	...
	//void startWorker(DebugInterface* cpu, const SearchType type, const SearchComparison comparison, std::vector<SearchResult>& searchResults, u32 start, u32 end, QString value, int base);
